...
export function JoystickControls({
  ...
  return (
    <>
      <div
        ref={zoneRef}
        className="pointer-events-auto absolute bottom-6 left-6 h-24 w-24 lg:h-36 lg:w-36 rounded-full bg-black/20 backdrop-blur-2xl border border-white/[0.08] shadow-[0_4px_24px_rgba(0,0,0,0.3)] flex items-center justify-center"
      >
        <svg
          width="800px"
          height="800px"
